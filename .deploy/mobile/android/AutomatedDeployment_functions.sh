...
function PrepareAndroidSDK_B() {
  ...
  # 3
  echo -e "getPlugin \"Android SDK Platform-tools, revision 23.0.1\" ${ANDROID_HOME}/platform-tools/adb;";
...
function BuildAndroidAPK_A() {
  ...
  pushd ${BUILD_DIRECTORY} >/dev/null;
    ...
    wget -nc https://raw.githubusercontent.com/martinhbramwell/Meteor-CI-Tutorial/master/fragments/getAPK.js;
    wget -nc https://raw.githubusercontent.com/martinhbramwell/Meteor-CI-Tutorial/master/fragments/getAPK.html;
...
function BuildAndroidAPK_B() {
  ...
  pushd ${TARGET_DIRECTORY}/android >/dev/null;
    ...
    ${ZIPALIGN_PATH}/zipalign -f ${ZIPALIGN_BOUNDARY} ${PROJECT_NAME}_unaligned.apk ${PROJECT_NAME}.apk;
